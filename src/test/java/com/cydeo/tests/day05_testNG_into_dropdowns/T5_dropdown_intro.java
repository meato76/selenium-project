...
public class T5_dropdown_intro {
    ...
    public void simple_dropdowns_test() {
        ...
        // Creating class object and passing the dropdown web element into the constructor
        ...
        //Expected: "Select a State
        String expectedDefaultStat ="Select a State";

       //Actual:
        String actualDefaultStat = select1.getFirstSelectedOption().getText();

        Assert.assertEquals(actualDefaultStat, expectedDefaultStat);
